package com.app.backendapp22.model;
...
import com.app.backendapp22.converter.DurationConverter;
import com.app.backendapp22.converter.UUIDToByteConverter;
import com.app.backendapp22.converter.UUIDToStringConverter;
...
@Table(name = "\"PetCareCenter\"", schema =  "\"backendapp22\"")
@Data
...
@Column(name = "\"BusinessHours\"")
    ...
    @CollectionTable(schema = "\"backendapp22\"", name = "\"PetCareCenterBusinessHours\"",joinColumns = @JoinColumn(name = "\"PcId\""))
...
@JoinTable(
            ...
            inverseJoinColumns = @JoinColumn( name="\"DocId\""), schema = "\"backendapp22\"")
...
@JoinTable(
            ...
            joinColumns = @JoinColumn( name="\"PcId\""),
            inverseJoinColumns = @JoinColumn( name="\"ServiceId\""), schema = "\"backendapp22\"")
...
@JoinTable(
            ...
            joinColumns = @JoinColumn( name="\"PcId\""),
            inverseJoinColumns = @JoinColumn( name="\"PetId\""), schema = "\"backendapp22\"")
